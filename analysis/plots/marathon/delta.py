...
if __name__=="__main__":
    ...
    ax12 = py.subplot(nrows,ncols,1)

    wdir1 = 'results/marathon/step29pos'
    #wdir1 = 'results/marathon/nooff'
    ...
    ax12.text(0.05,0.60,r'$Q^2=%s{\rm~GeV^2}$'%Q2,size=30,transform=ax12.transAxes)

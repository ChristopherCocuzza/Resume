...
#conf['steps'][13]['datasets']['idis'].append(10041) # h/d      | F2h/F2d       | JLab Hall C (E03-103)
#conf['steps'][13]['datasets']['idis'].append(10050) # d/p      | F2d/F2p       | MARATHON
#conf['steps'][13]['datasets']['idis'].append(10051) # h/t      | F2h/F2t       | MARATHON
conf['steps'][13]['datasets']['dy']=[]
conf['steps'][13]['datasets']['dy'].append(10001)
conf['steps'][13]['datasets']['dy'].append(20001)
...
conf['steps'][13]['datasets']['wzrv'].append(2010)
conf['steps'][13]['datasets']['wzrv'].append(2011)
conf['steps'][13]['datasets']['wzrv'].append(2012)
conf['steps'][13]['datasets']['wzrv'].append(2013)
conf['steps'][13]['datasets']['wzrv'].append(2014)
conf['steps'][13]['datasets']['wzrv'].append(2016)
conf['steps'][13]['datasets']['wzrv'].append(2017)
conf['steps'][13]['datasets']['jet'] = []
conf['steps'][13]['datasets']['jet'].append(10001) ## D0 dataset
conf['steps'][13]['datasets']['jet'].append(10002) ## CDF dataset
conf['steps'][13]['datasets']['jet'].append(10003) ## STAR MB dataset
conf['steps'][13]['datasets']['jet'].append(10004) ## STAR HT dataset
...
conf['FILT']['value'].append(('pdf','db/ub','>',1.7,0.20,10))
conf['FILT']['value'].append(('pdf','db/ub','>',5.0,0.38,10))
conf['FILT']['value'].append(('pdf','db/ub','<',0.0,0.35,10))

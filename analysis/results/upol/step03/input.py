...
#--reduce W2 cut to 3, add JLab data (no A = 3)
conf['ftol']=1e-6
conf['tmc']   = False
conf['ht']    = False
conf['ht type'] = 'mult'
...
conf['steps'][3]['datasets']['idis'].append(10002) # deuteron | F2            | JLab Hall C (E00-106)
conf['steps'][3]['datasets']['idis'].append(10003) # proton   | F2            | JLab Hall C (E00-106)
conf['steps'][3]['datasets']['idis'].append(10033) # n/d      | F2n/F2d       | BONUS
#conf['steps'][3]['datasets']['idis'].append(10041) # h/d      | sigh/sigd     | JLab Hall C (E03-103)
#conf['steps'][3]['datasets']['idis'].append(10050) # d/p      | F2d/F2p       | MARATHON
#conf['steps'][3]['datasets']['idis'].append(10051) # h/t      | F2h/F2t       | MARATHON
#conf['steps'][3]['datasets']['dy']=[]
#conf['steps'][3]['datasets']['dy'].append(10001)
#conf['steps'][3]['datasets']['dy'].append(10002)
#conf['steps'][3]['datasets']['zrap']=[]
#conf['steps'][3]['datasets']['zrap'].append(1000)
#conf['steps'][3]['datasets']['zrap'].append(1001)
#conf['steps'][3]['datasets']['wasym']=[]
#conf['steps'][3]['datasets']['wasym'].append(1000)
#conf['steps'][3]['datasets']['wasym'].append(1001)
#conf['steps'][3]['datasets']['wzrv']=[]
#conf['steps'][3]['datasets']['wzrv'].append(2000)
#conf['steps'][3]['datasets']['wzrv'].append(2003)
#conf['steps'][3]['datasets']['wzrv'].append(2006)
#conf['steps'][3]['datasets']['wzrv'].append(2007)
#conf['steps'][3]['datasets']['wzrv'].append(2009)
#conf['steps'][3]['datasets']['wzrv'].append(2010)
#conf['steps'][3]['datasets']['wzrv'].append(2011)
#conf['steps'][3]['datasets']['wzrv'].append(2012)
#conf['steps'][3]['datasets']['wzrv'].append(2013)
#conf['steps'][3]['datasets']['wzrv'].append(2014)
#conf['steps'][3]['datasets']['wzrv'].append(2015)
#conf['steps'][3]['datasets']['jet'] = []
#conf['steps'][3]['datasets']['jet'].append(10001) ## D0 dataset
#conf['steps'][3]['datasets']['jet'].append(10002) ## CDF dataset
#conf['steps'][3]['datasets']['jet'].append(10003) ## STAR MB dataset
#conf['steps'][3]['datasets']['jet'].append(10004) ## STAR HT dataset

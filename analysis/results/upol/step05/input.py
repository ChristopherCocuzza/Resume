...
#--add higher twist corrections (p=n)
conf['ftol']=1e-6
conf['tmc']   = 'AOT'
conf['ht']    = True
conf['ht type'] = 'mult'
...
conf['steps'][5]={}
conf['steps'][5]['dep']=[4]
conf['steps'][5]['active distributions']=['pdf','ht4']
...
#conf['steps'][5]['datasets']['idis'].append(10041) # h/d      | sigh/sigd     | JLab Hall C (E03-103)
#conf['steps'][5]['datasets']['idis'].append(10050) # d/p      | F2d/F2p       | MARATHON
#conf['steps'][5]['datasets']['idis'].append(10051) # h/t      | F2h/F2t       | MARATHON
#conf['steps'][5]['datasets']['dy']=[]
#conf['steps'][5]['datasets']['dy'].append(10001)
#conf['steps'][5]['datasets']['dy'].append(10002)
#conf['steps'][5]['datasets']['zrap']=[]
#conf['steps'][5]['datasets']['zrap'].append(1000)
#conf['steps'][5]['datasets']['zrap'].append(1001)
#conf['steps'][5]['datasets']['wasym']=[]
#conf['steps'][5]['datasets']['wasym'].append(1000)
#conf['steps'][5]['datasets']['wasym'].append(1001)
#conf['steps'][5]['datasets']['wzrv']=[]
#conf['steps'][5]['datasets']['wzrv'].append(2000)
#conf['steps'][5]['datasets']['wzrv'].append(2003)
#conf['steps'][5]['datasets']['wzrv'].append(2006)
#conf['steps'][5]['datasets']['wzrv'].append(2007)
#conf['steps'][5]['datasets']['wzrv'].append(2009)
#conf['steps'][5]['datasets']['wzrv'].append(2010)
#conf['steps'][5]['datasets']['wzrv'].append(2011)
#conf['steps'][5]['datasets']['wzrv'].append(2012)
#conf['steps'][5]['datasets']['wzrv'].append(2013)
#conf['steps'][5]['datasets']['wzrv'].append(2014)
#conf['steps'][5]['datasets']['wzrv'].append(2015)

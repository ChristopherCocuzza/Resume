...
conf['steps'][7]={}
conf['steps'][7]['dep']=[6]
conf['steps'][7]['active distributions']=['pdf','ht4']
...
#conf['steps'][7]['datasets']['idis'].append(10041) # h/d      | sigh/sigd     | JLab Hall C (E03-103)
#conf['steps'][7]['datasets']['idis'].append(10050) # d/p      | F2d/F2p       | MARATHON
#conf['steps'][7]['datasets']['idis'].append(10051) # h/t      | F2h/F2t       | MARATHON
conf['steps'][7]['datasets']['dy']=[]
conf['steps'][7]['datasets']['dy'].append(10001)
conf['steps'][7]['datasets']['dy'].append(20001)
#conf['steps'][7]['datasets']['zrap']=[]
#conf['steps'][7]['datasets']['zrap'].append(1000)
#conf['steps'][7]['datasets']['zrap'].append(1001)
#conf['steps'][7]['datasets']['wasym']=[]
#conf['steps'][7]['datasets']['wasym'].append(1000)
#conf['steps'][7]['datasets']['wasym'].append(1001)
#conf['steps'][7]['datasets']['wzrv']=[]
#conf['steps'][7]['datasets']['wzrv'].append(2000)
#conf['steps'][7]['datasets']['wzrv'].append(2003)
#conf['steps'][7]['datasets']['wzrv'].append(2006)
#conf['steps'][7]['datasets']['wzrv'].append(2007)
#conf['steps'][7]['datasets']['wzrv'].append(2009)
#conf['steps'][7]['datasets']['wzrv'].append(2010)
#conf['steps'][7]['datasets']['wzrv'].append(2011)
#conf['steps'][7]['datasets']['wzrv'].append(2012)
#conf['steps'][7]['datasets']['wzrv'].append(2013)
#conf['steps'][7]['datasets']['wzrv'].append(2014)
#conf['steps'][7]['datasets']['wzrv'].append(2015)
#conf['steps'][7]['datasets']['jet'] = []
#conf['steps'][7]['datasets']['jet'].append(10001) ## D0 dataset
#conf['steps'][7]['datasets']['jet'].append(10002) ## CDF dataset
#conf['steps'][7]['datasets']['jet'].append(10003) ## STAR MB dataset
#conf['steps'][7]['datasets']['jet'].append(10004) ## STAR HT dataset

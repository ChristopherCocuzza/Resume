...
conf['steps'][6]={}
conf['steps'][6]['dep']=[5]
conf['steps'][6]['active distributions']=['pdf','ht4']
...
#conf['steps'][6]['datasets']['idis'].append(10041) # h/d      | sigh/sigd     | JLab Hall C (E03-103)
#conf['steps'][6]['datasets']['idis'].append(10050) # d/p      | F2d/F2p       | MARATHON
#conf['steps'][6]['datasets']['idis'].append(10051) # h/t      | F2h/F2t       | MARATHON
conf['steps'][6]['datasets']['dy']=[]
conf['steps'][6]['datasets']['dy'].append(10001)
conf['steps'][6]['datasets']['dy'].append(20001)
#conf['steps'][6]['datasets']['zrap']=[]
#conf['steps'][6]['datasets']['zrap'].append(1000)
#conf['steps'][6]['datasets']['zrap'].append(1001)
#conf['steps'][6]['datasets']['wasym']=[]
#conf['steps'][6]['datasets']['wasym'].append(1000)
#conf['steps'][6]['datasets']['wasym'].append(1001)
#conf['steps'][6]['datasets']['wzrv']=[]
#conf['steps'][6]['datasets']['wzrv'].append(2000)
#conf['steps'][6]['datasets']['wzrv'].append(2003)
#conf['steps'][6]['datasets']['wzrv'].append(2006)
#conf['steps'][6]['datasets']['wzrv'].append(2007)
#conf['steps'][6]['datasets']['wzrv'].append(2009)
#conf['steps'][6]['datasets']['wzrv'].append(2010)
#conf['steps'][6]['datasets']['wzrv'].append(2011)
#conf['steps'][6]['datasets']['wzrv'].append(2012)
#conf['steps'][6]['datasets']['wzrv'].append(2013)
#conf['steps'][6]['datasets']['wzrv'].append(2014)
#conf['steps'][6]['datasets']['wzrv'].append(2015)

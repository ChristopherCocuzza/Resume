...
conf['datasets']['idis']['xlsx'][10050]='idis/expdata/10050c.xlsx' # d/p      | F2d/F2p       | MARATHON
conf['datasets']['idis']['xlsx'][10051]='idis/expdata/10051c.xlsx' # h/t      | F2h/F2t       | MARATHON
#------------------------------------------------------------------------------------------------------------------
...
conf['offpdf'] = True
conf['steps'][istep]={}
conf['steps'][istep]['dep']=[17]
conf['steps'][istep]['active distributions']=['pdf','ht4','off pdf']
conf['steps'][istep]['passive distributions']=[]
conf['params']['off pdf']['uv1 N']['zero'] = True
conf['params']['off pdf']['dv1 N']['zero'] = True
#------------------------------------------------------------------------------------------------------------------

...
istep=24
#--fit pion PSIDIS (PDIS W2 > 10, Q2 > mc2, no Ape (w/ smearing, valence parameterization, OS for all, SU2+SU3 from JAM17, g2 = 0))
conf['ftol']=1e-6
conf['tmc']     = 'AOT'
conf['ht']      = True
conf['ht type'] = 'mult'
...
conf['ww']  = False
conf['steps'][istep]={}
conf['steps'][istep]['dep']=[19,22,23]
conf['steps'][istep]['active distributions']=['ppdf','ffpion']

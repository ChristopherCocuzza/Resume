...
conf['datasets']['idis']['xlsx'][10042]='idis/expdata/10042.xlsx' 
...
istep=19
#--iterate on step18pos using opt-priors
conf['ftol']=1e-6
conf['tmc']   = 'AOT'
conf['ht']    = True
conf['ht type'] = 'mult'
...
conf['steps'][istep]['datasets']['idis'].append(10042)

conf['FILT'] = {_:[] for _ in ['exp','par','value']}

conf['FILT']['exp'].append(('idis' ,10042,10))

conf['FILT']['par'].append(('off pdf','dv1 N','<',0.0001))

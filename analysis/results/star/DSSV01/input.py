...
conf['params']['ppdf']['g1 b']    = {'value':    10.00000000, 'min':     0, 'max':    30, 'fixed': True}
conf['params']['ppdf']['g1 d']    = {'value':    0.00000e+00, 'min': -1000, 'max':   100, 'fixed': True}

conf['params']['ppdf']['up1 N']   = {'value':    3.47549e-01, 'min':   -10, 'max':    10, 'fixed': False}
conf['params']['ppdf']['up1 a']   = {'value':    2.92830e-01, 'min': -0.99, 'max':     5, 'fixed': False}
conf['params']['ppdf']['up1 b']   = {'value':    2.95841e+00, 'min':     0, 'max':    30, 'fixed': False}
conf['params']['ppdf']['up1 c']   = {'value':    0.000000000, 'min':  -100, 'max':   100, 'fixed': True}
conf['params']['ppdf']['up1 d']   = {'value':    0.000000000, 'min':  -100, 'max':   100, 'fixed': True}

conf['params']['ppdf']['dp1 N']   = {'value':    1.52089e-01, 'min':   -10, 'max':    10, 'fixed': False}
conf['params']['ppdf']['dp1 a']   = {'value':    5.34011e-01, 'min': -0.99, 'max':     5, 'fixed': False}
conf['params']['ppdf']['dp1 b']   = {'value':    2.01125e+00, 'min':     0, 'max':    30, 'fixed': False}
conf['params']['ppdf']['dp1 c']   = {'value':    0.000000000, 'min':  -100, 'max':   100, 'fixed': True}
conf['params']['ppdf']['dp1 d']   = {'value':    0.000000000, 'min':  -100, 'max':   100, 'fixed': True}

conf['params']['ppdf']['ub1 N']   = {'value':   -1.21705e-01, 'min':   -10, 'max':    10, 'fixed': False}
conf['params']['ppdf']['ub1 a']   = {'value':    1.36941e+00, 'min': -0.99, 'max':     5, 'fixed': 'up1 a'}
conf['params']['ppdf']['ub1 b']   = {'value':    10.00000000, 'min':     0, 'max':    30, 'fixed': True}
conf['params']['ppdf']['ub1 d']   = {'value':    0.000000000, 'min':  -100, 'max':   100, 'fixed': True}

conf['params']['ppdf']['db1 N']   = {'value':   -1.21705e-01, 'min':   -10, 'max':    10, 'fixed': False}
conf['params']['ppdf']['db1 a']   = {'value':    1.36941e+00, 'min': -0.99, 'max':     5, 'fixed': 'dp1 a'}
conf['params']['ppdf']['db1 b']   = {'value':    10.00000000, 'min':     0, 'max':    30, 'fixed': True}
conf['params']['ppdf']['db1 d']   = {'value':    0.000000000, 'min':  -100, 'max':   100, 'fixed': True}

conf['params']['ppdf']['sb1 N']   = {'value':    1.52089e-01, 'min':   -10, 'max':    10, 'fixed': False}
conf['params']['ppdf']['sb1 a']   = {'value':    5.34011e-01, 'min': -0.99, 'max':     5, 'fixed': 'dp1 a'}
conf['params']['ppdf']['sb1 b']   = {'value':    10.00000000, 'min':     0, 'max':    30, 'fixed': True}
conf['params']['ppdf']['sb1 d']   = {'value':    0.000000000, 'min':  -100, 'max':   100, 'fixed': True}

conf['params']['ppdf']['s1 N']    = {'value':    1.52089e-01, 'min':   -10, 'max':    10, 'fixed': 'sb1 N'}
conf['params']['ppdf']['s1 a']    = {'value':    5.34011e-01, 'min': -0.99, 'max':     5, 'fixed': 'dp1 a'}
conf['params']['ppdf']['s1 b']    = {'value':    10.00000000, 'min':     0, 'max':    30, 'fixed': 'sb1 b'}
conf['params']['ppdf']['s1 d']    = {'value':    0.000000000, 'min':  -100, 'max':   100, 'fixed': 'sb1 d'}
...
#--pion fragmentation
conf['ffpion parametrization']='DSSV'
conf['params']['ffpion']={}

conf['params']['ffpion']['g1 N']  ={'value':    0.279, 'min':  0.0 , 'max':     1,'fixed':True}
conf['params']['ffpion']['g1 a']  ={'value':    0.899, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffpion']['g1 b']  ={'value':    1.570, 'min':  0   , 'max':    30,'fixed':True}
conf['params']['ffpion']['g1 c']  ={'value':    20.00, 'min':  0   , 'max':    30,'fixed':True}
conf['params']['ffpion']['g1 d']  ={'value':    4.910, 'min':  0   , 'max':    30,'fixed':True}
                                                                                     
conf['params']['ffpion']['up1 N'] ={'value':    0.345, 'min':  0.0 , 'max':     1,'fixed':True}
conf['params']['ffpion']['up1 a'] ={'value':   -0.015, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffpion']['up1 b'] ={'value':    1.200, 'min':  0   , 'max':    30,'fixed':True}
conf['params']['ffpion']['up1 c'] ={'value':    11.06, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffpion']['up1 d'] ={'value':    4.230, 'min':  0   , 'max':    30,'fixed':True}
                                                                                       
conf['params']['ffpion']['dp1 N'] ={'value':    0.380, 'min':  0.0 , 'max':     1,'fixed':True}
conf['params']['ffpion']['dp1 a'] ={'value':   -0.015, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffpion']['dp1 b'] ={'value':    1.200, 'min':  0   , 'max':    30,'fixed':True}
conf['params']['ffpion']['dp1 c'] ={'value':    11.06, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffpion']['dp1 d'] ={'value':    4.260, 'min':  0   , 'max':    30,'fixed':True}
                                                                                      
conf['params']['ffpion']['ub1 N'] ={'value':    0.115, 'min':  0.0 , 'max':     1,'fixed':True}
conf['params']['ffpion']['ub1 a'] ={'value':    0.520, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffpion']['ub1 b'] ={'value':    3.270, 'min':  0   , 'max':    30,'fixed':True}
conf['params']['ffpion']['ub1 c'] ={'value':    16.26, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffpion']['ub1 d'] ={'value':    8.460, 'min':  0   , 'max':    30,'fixed':True}
  
conf['params']['ffpion']['s1 N']  ={'value':    0.095, 'min':  0.0 , 'max':     1,'fixed':True}
conf['params']['ffpion']['s1 a']  ={'value':    0.520, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffpion']['s1 b']  ={'value':    3.270, 'min':  0   , 'max':    30,'fixed':True}
conf['params']['ffpion']['s1 c']  ={'value':    16.26, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffpion']['s1 d']  ={'value':    8.460, 'min':  0   , 'max':    30,'fixed':True}
                                                                                       
conf['params']['ffpion']['c1 N']  ={'value':    0.1355, 'min':  0.0 , 'max':     1,'fixed':True}
conf['params']['ffpion']['c1 a']  ={'value':   -0.9050, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffpion']['c1 b']  ={'value':    3.2300, 'min':  0   , 'max':    30,'fixed':True}
                                                                                        
conf['params']['ffpion']['b1 N']  ={'value':    0.2505, 'min':  0.0 , 'max':     1,'fixed':True}
conf['params']['ffpion']['b1 a']  ={'value':   -1.3050, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffpion']['b1 b']  ={'value':    5.6700, 'min':  0   , 'max':    30,'fixed':True}
                                                                                        
conf['params']['ffpion']['sb1 N'] ={'value':    0.095, 'min':  0.0 , 'max':     1,'fixed':'s1 N'}
conf['params']['ffpion']['sb1 a'] ={'value':    0.520, 'min': -1.8 , 'max':    10,'fixed':'s1 a'}
conf['params']['ffpion']['sb1 b'] ={'value':    3.270, 'min':  0   , 'max':    30,'fixed':'s1 b'}
conf['params']['ffpion']['sb1 c'] ={'value':    16.26, 'min': -1.8 , 'max':    10,'fixed':'s1 c'}
conf['params']['ffpion']['sb1 d'] ={'value':    8.460, 'min':  0   , 'max':    30,'fixed':'s1 d'}
                                                                                       
conf['params']['ffpion']['cb1 N'] ={'value':    0.1355, 'min':  0.0 , 'max':     1,'fixed':'c1 N'}
conf['params']['ffpion']['cb1 a'] ={'value':   -0.9050, 'min': -1.8 , 'max':    10,'fixed':'c1 a'}
conf['params']['ffpion']['cb1 b'] ={'value':    3.2300, 'min':  0   , 'max':    30,'fixed':'c1 b'}
                                                                                       
conf['params']['ffpion']['bb1 N'] ={'value':    0.2505, 'min':  0.0 , 'max':     1,'fixed':'b1 N'}
conf['params']['ffpion']['bb1 a'] ={'value':   -1.3050, 'min': -1.8 , 'max':    10,'fixed':'b1 a'}
conf['params']['ffpion']['bb1 b'] ={'value':    5.6700, 'min':  0   , 'max':    30,'fixed':'b1 b'}
                                   

#--kaon fragmentation
conf['params']['ffkaon']={}
conf['ffkaon parametrization']='DSSV'

conf['params']['ffkaon']['g1 N']  ={'value':   0.0170, 'min':  0.0 , 'max':     1,'fixed':True}
conf['params']['ffkaon']['g1 a']  ={'value':   5.0550, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffkaon']['g1 b']  ={'value':   1.2000, 'min':  0   , 'max':    30,'fixed':True}
conf['params']['ffkaon']['g1 c']  ={'value':   0.0000, 'min':  0   , 'max':    30,'fixed':True}
conf['params']['ffkaon']['g1 d']  ={'value':   0.0000, 'min':  0   , 'max':    30,'fixed':True}
                                                                             
conf['params']['ffkaon']['up1 N'] ={'value':   0.0580, 'min':  0.0 , 'max':     1,'fixed':True}
conf['params']['ffkaon']['up1 a'] ={'value':   0.7050, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffkaon']['up1 b'] ={'value':   1.2000, 'min':  0   , 'max':    30,'fixed':True}
conf['params']['ffkaon']['up1 c'] ={'value':   15.000, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffkaon']['up1 d'] ={'value':   6.0200, 'min':  0   , 'max':    30,'fixed':True}

conf['params']['ffkaon']['sp1 N'] ={'value':   0.3430, 'min':  0.0 , 'max':     1,'fixed':True}
conf['params']['ffkaon']['sp1 a'] ={'value':  -0.0650, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffkaon']['sp1 b'] ={'value':   1.2000, 'min':  0   , 'max':    30,'fixed':True}
conf['params']['ffkaon']['sp1 c'] ={'value':   4.3600, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffkaon']['sp1 d'] ={'value':   3.7300, 'min':  0   , 'max':    30,'fixed':True}
                                                                               
conf['params']['ffkaon']['dp1 N'] ={'value':   0.0160, 'min':  0.0 , 'max':     1,'fixed':True}
conf['params']['ffkaon']['dp1 a'] ={'value':   1.1080, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffkaon']['dp1 b'] ={'value':   10.000, 'min':  0   , 'max':    30,'fixed':True}
conf['params']['ffkaon']['dp1 c'] ={'value':   10.000, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffkaon']['dp1 d'] ={'value':   3.2800, 'min':  0   , 'max':    30,'fixed':True}
                                                                             
conf['params']['ffkaon']['ub1 N'] ={'value':   0.0080, 'min':  0.0 , 'max':     1,'fixed':True}
conf['params']['ffkaon']['ub1 a'] ={'value':   1.1080, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffkaon']['ub1 b'] ={'value':   10.000, 'min':  0   , 'max':    30,'fixed':True}
conf['params']['ffkaon']['ub1 c'] ={'value':   10.000, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffkaon']['ub1 d'] ={'value':   3.2800, 'min':  0   , 'max':    30,'fixed':True}
  
conf['params']['ffkaon']['c1 N']  ={'value':   0.0980, 'min':  0.0 , 'max':     1,'fixed':True}
conf['params']['ffkaon']['c1 a']  ={'value':   0.1020, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffkaon']['c1 b']  ={'value':   4.5600, 'min':  0   , 'max':    30,'fixed':True}
                                                                               
conf['params']['ffkaon']['b1 N']  ={'value':   0.0695, 'min':  0.0 , 'max':     1,'fixed':True}
conf['params']['ffkaon']['b1 a']  ={'value':  -0.5840, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['ffkaon']['b1 b']  ={'value':   7.4200, 'min':  0   , 'max':    30,'fixed':True}
                                                                                
conf['params']['ffkaon']['cb1 N'] ={'value':   0.0980, 'min':  0.0 , 'max':     1,'fixed':'c1 N'}
conf['params']['ffkaon']['cb1 a'] ={'value':   0.1020, 'min': -1.8 , 'max':    10,'fixed':'c1 a'}
conf['params']['ffkaon']['cb1 b'] ={'value':   4.5600, 'min':  0   , 'max':    30,'fixed':'c1 b'}
                                                                              
conf['params']['ffkaon']['bb1 N'] ={'value':   0.0695, 'min':  0.0 , 'max':     1,'fixed':'b1 N'}
conf['params']['ffkaon']['bb1 a'] ={'value':  -0.5840, 'min': -1.8 , 'max':    10,'fixed':'b1 a'}
conf['params']['ffkaon']['bb1 b'] ={'value':   7.4200, 'min':  0   , 'max':    30,'fixed':'b1 b'}
...
istep=20
#--DSSVlike analysis (PDIS W2 > 10, Q2 > , no Ape (w/ smearing, valence parameterization, OS+ for all, g2 = 0))
#--use positivity constraints, SU2 + SU3, no RHIC, with DSSV FFs
#--use plus parametrization
#--fix b to 10 for ub, db, s, sb, g
#--also set alpha equal for ub, u
#--also set alpha equal for s, sb, db, d
#--use Q20 = 1 since FFs are given at Q2 = 1
#--start with c and d parameters set to zero
conf['ftol']=1e-6
conf['tmc']     = 'AOT'
conf['ht']      = True
conf['ht type'] = 'mult'
...
conf['ww']  = False
conf['positivity constraints'] = True
conf['steps'][istep]={}
conf['steps'][istep]['dep']=[19]
conf['steps'][istep]['active distributions']=['ppdf','ffpion','ffkaon']
...
conf['steps'][istep]['datasets']['SU23'].append(10001)
conf['steps'][istep]['datasets']['SU23'].append(10002)
...
conf['FILT']['exp'].append(('SU23',10001,10))
conf['FILT']['exp'].append(('SU23',10002,10))

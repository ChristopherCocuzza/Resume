...
conf['datasets']['zrap']['norm'][1010]={'value':    1,'fixed':False,'min':   0.5,'max':    1.5}
#------------------------------------------------------------------------------------------------------------------
...
istep=17
#--test inclusion of ATLAS Z data
conf['ftol']=1e-6
conf['tmc']   = 'AOT'
conf['ht']    = True
conf['ht type'] = 'mult'
...
conf['steps'][istep]['datasets']['zrap'].append(1010)

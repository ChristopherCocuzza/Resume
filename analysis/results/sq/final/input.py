...
istep=16
#--iterate on step15 using opt-priors
conf['ftol']=1e-6
conf['tmc']   = 'AOT'
conf['ht']    = True
conf['ht type'] = 'mult'
...
conf['FILT']['value'].append(('pdf','db/ub','<',0.0,0.40,10))
conf['FILT']['value'].append(('pdf','db/ub','<',0.0,0.38,10))
conf['FILT']['value'].append(('pdf','db/ub','<',0.0,0.36,10))
conf['FILT']['value'].append(('pdf','db/ub','<',0.0,0.26,10))
conf['FILT']['value'].append(('pdf','db/ub','<',1.0,0.28,10))
conf['FILT']['value'].append(('pdf','db/ub','>',5.0,0.40,10))
conf['FILT']['value'].append(('pdf','db/ub','<',0.0,0.35,10))
conf['FILT']['value'].append(('pdf','db/ub','>',3.0,0.35,10))

...
conf['params']['ppdf']['g1 d']    = {'value':    0.00000e+00, 'min': -1000, 'max':   100, 'fixed': False}
...
conf['params']['ppdf']['up1 c']   = {'value':    0.000000000, 'min':  -100, 'max':   100, 'fixed': False}
conf['params']['ppdf']['up1 d']   = {'value':    0.000000000, 'min':  -100, 'max':   100, 'fixed': False}
...
conf['params']['ppdf']['dp1 c']   = {'value':    0.000000000, 'min':  -100, 'max':   100, 'fixed': False}
conf['params']['ppdf']['dp1 d']   = {'value':    0.000000000, 'min':  -100, 'max':   100, 'fixed': False}
...
conf['params']['ppdf']['ub1 d']   = {'value':    0.000000000, 'min':  -100, 'max':   100, 'fixed': False}
...
conf['params']['ppdf']['db1 d']   = {'value':    0.000000000, 'min':  -100, 'max':   100, 'fixed': False}
...
conf['params']['ppdf']['sb1 d']   = {'value':    0.000000000, 'min':  -100, 'max':   100, 'fixed': False}

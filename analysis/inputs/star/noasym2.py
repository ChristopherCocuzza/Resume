...
conf['params']['ppdf']['db1 N']   = {'value':   -1.21705e-01, 'min':   -10, 'max':    10, 'fixed': 'ub1 N'}
conf['params']['ppdf']['db1 a']   = {'value':    1.36941e+00, 'min': -0.99, 'max':     5, 'fixed': 'ub1 a'}
conf['params']['ppdf']['db1 b']   = {'value':    9.99976e+00, 'min':     0, 'max':    30, 'fixed': 'ub1 b'}
conf['params']['ppdf']['db1 d']   = {'value':    0.000000000, 'min':   -10, 'max':    10, 'fixed': 'ub1 d'}
...
istep=41
#--set asymmetry to zero (PDIS W2 > 10, Q2 > mc2, no Ape (w/ smearing, valence parameterization, OS+ for all, g2 = 0))
conf['ftol']=1e-6
conf['tmc']     = 'AOT'
conf['ht']      = True
conf['ht type'] = 'mult'
...
conf['ww']  = False
conf['steps'][istep]={}
conf['steps'][istep]['dep']=[19,40]
conf['steps'][istep]['active distributions']=['ppdf','ffpion','ffkaon','ffhadron','pdf','ht4','off pdf']

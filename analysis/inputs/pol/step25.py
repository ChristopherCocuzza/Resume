...
istep=25
#--free ffpion s (PDIS W2 > 10, Q2 > mc2, no Ape (w/ smearing, valence parameterization, OS+ for all, g2 = 0))
conf['ftol']=1e-6
conf['tmc']     = 'AOT'
conf['ht']      = True
conf['ht type'] = 'mult'
...
conf['params']['ffpion']['s1 N']['prior'] = 'd1 N'
conf['params']['ffpion']['s1 a']['prior'] = 'd1 a'
conf['params']['ffpion']['s1 b']['prior'] = 'd1 b'
#------------------------------------------------------------------------------------------------------------------

...
conf['params']['ffkaon']['s1 b']  ={'value':   1.65143e+00, 'min':  5   , 'max':    30,'fixed':'d1 b'}
...
istep=27
#--fit kaon SIA (PDIS W2 > 10, Q2 > mc2, no Ape (w/ smearing, valence parameterization, OS+ for all, g2 = 0))
conf['ftol']=1e-6
conf['tmc']     = 'AOT'
conf['ht']      = True
conf['ht type'] = 'mult'
...
conf['ww']  = False
conf['steps'][istep]={}
conf['steps'][istep]['dep']=[19,26]
conf['steps'][istep]['active distributions']=['ffkaon']
conf['steps'][istep]['passive distributions']=['pdf','ht4','off pdf','ppdf','ffpion']
#------------------------------------------------------------------------------------------------------------------
...
conf['FILT']['exp'].append(('sia',2001,10))
conf['FILT']['exp'].append(('sia',2002,10))
conf['FILT']['exp'].append(('sia',2003,10))
conf['FILT']['exp'].append(('sia',2004,10))
conf['FILT']['exp'].append(('sia',2005,10))
conf['FILT']['exp'].append(('sia',2006,10))
conf['FILT']['exp'].append(('sia',2007,10))
conf['FILT']['exp'].append(('sia',2008,10))
conf['FILT']['exp'].append(('sia',2012,10))
conf['FILT']['exp'].append(('sia',2013,10))
conf['FILT']['exp'].append(('sia',2014,10))
conf['FILT']['exp'].append(('sia',2016,10))
conf['FILT']['exp'].append(('sia',2017,10))
conf['FILT']['exp'].append(('sia',2018,10))
conf['FILT']['exp'].append(('sia',2019,10))
conf['FILT']['exp'].append(('sia',2023,10))
conf['FILT']['exp'].append(('sia',2024,10))
conf['FILT']['exp'].append(('sia',2025,10))
conf['FILT']['exp'].append(('sia',2027,10))
conf['FILT']['exp'].append(('sia',2028,10))
conf['FILT']['exp'].append(('sia',2029,10))
conf['FILT']['exp'].append(('sia',2030,10))
conf['FILT']['exp'].append(('sia',2031,10))

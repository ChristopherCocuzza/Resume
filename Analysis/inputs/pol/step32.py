...
istep=32
#--add unpolarized SIDIS pion w/ PPDFs and ffkaon fixed (PDIS W2 > 10, Q2 > mc2, no Ape (w/ smearing, valence parameterization, OS+ for all, g2 = 0))
conf['ftol']=1e-6
conf['tmc']     = 'AOT'
conf['ht']      = True
conf['ht type'] = 'mult'
...
conf['ww']  = False
conf['steps'][istep]={}
conf['steps'][istep]['dep']=[19,31]
conf['steps'][istep]['active distributions']=['ffpion']
conf['steps'][istep]['passive distributions']=['pdf','ht4','off pdf','ppdf','ffkaon']
#------------------------------------------------------------------------------------------------------------------

...
conf['offpdf'] = False
conf['steps'][istep]={}
conf['steps'][istep]['dep']=[2]
conf['steps'][istep]['active distributions']=['pdf']
...
#conf['steps'][istep]['datasets']['idis'].append(10041) # h/d      | sigh/sigd     | JLab Hall C (E03-103)
...
#conf['steps'][istep]['datasets']['dy'].append(10002)
...
#conf['steps'][istep]['datasets']['wzrv'].append(2015)

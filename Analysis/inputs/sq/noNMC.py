...
#conf['steps'][istep]['datasets']['wzrv'].append(2000)
#conf['steps'][istep]['datasets']['wzrv'].append(2003)
#conf['steps'][istep]['datasets']['wzrv'].append(2006)
#conf['steps'][istep]['datasets']['wzrv'].append(2007)
#conf['steps'][istep]['datasets']['wzrv'].append(2008)
#conf['steps'][istep]['datasets']['wzrv'].append(2009)

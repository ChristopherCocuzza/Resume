...
#------------------------------------------------------------------------------------------------------------------
conf['datasets']['idis']['xlsx'][10041]='idis/expdata/10041.xlsx' # h/d      | sigh/sigd     | JLab Hall C (E03-103)
...
conf['datasets']['dy']['norm'][10001]={'value':    1,'fixed':False,'min':   0.0,'max':    2.0}
conf['datasets']['dy']['norm'][10002]={'value':    1,'fixed':False,'min':   0.0,'max':    2.0}
#------------------------------------------------------------------------------------------------------------------
...
conf['params']['pdf']['mix N']    ={'value':    0.00000000e+00   , 'min':   0.0, 'max': 1.0, 'fixed': True}
conf['params']['pdf']['mix a']    ={'value':    2.00000000e+00   , 'min':   1.0, 'max': 6.0, 'fixed': True}
...
conf['params']['pdf']['sea3 N']  ={'value':    5.71081196e-03, 'min':     0, 'max':     1, 'fixed': 'sea1 N'}
conf['params']['pdf']['sea3 a']  ={'value':   -1.36329697e+00, 'min':  -1.9, 'max':    -1, 'fixed': 'sea1 a'}
conf['params']['pdf']['sea3 b']  ={'value':    4.74721050e+00, 'min':     0, 'max':   100, 'fixed': 'sea1 b'}
...
#--start: DIS fixed target with W2 > 10
conf['ftol']=1e-6
conf['tmc']   = False
conf['ht']    = False
conf['ht type'] = 'mult'
...
#conf['steps'][1]['datasets']['idis'].append(10026) # proton   | sigma red     | HERA II NC e+ (1)
#conf['steps'][1]['datasets']['idis'].append(10027) # proton   | sigma red     | HERA II NC e+ (2)
#conf['steps'][1]['datasets']['idis'].append(10028) # proton   | sigma red     | HERA II NC e+ (3)
#conf['steps'][1]['datasets']['idis'].append(10029) # proton   | sigma red     | HERA II NC e+ (4)
#conf['steps'][1]['datasets']['idis'].append(10030) # proton   | sigma red     | HERA II NC e-
#conf['steps'][1]['datasets']['idis'].append(10031) # proton   | sigma red     | HERA II CC e+
#conf['steps'][1]['datasets']['idis'].append(10032) # proton   | sigma red     | HERA II CC e-
#conf['steps'][1]['datasets']['idis'].append(10002) # deuteron | F2            | JLab Hall C (E00-106)
#conf['steps'][1]['datasets']['idis'].append(10003) # proton   | F2            | JLab Hall C (E00-106)
#conf['steps'][1]['datasets']['idis'].append(10033) # n/d      | F2n/F2d       | BONUS
#conf['steps'][1]['datasets']['idis'].append(10041) # h/d      | sigh/sigd     | JLab Hall C (E03-103)
#conf['steps'][1]['datasets']['idis'].append(10050) # d/p      | F2d/F2p       | MARATHON
#conf['steps'][1]['datasets']['idis'].append(10051) # h/t      | F2h/F2t       | MARATHON
#conf['steps'][1]['datasets']['dy']=[]
#conf['steps'][1]['datasets']['dy'].append(10001)
#conf['steps'][1]['datasets']['dy'].append(10002)
#conf['steps'][1]['datasets']['zrap']=[]
#conf['steps'][1]['datasets']['zrap'].append(1000)
#conf['steps'][1]['datasets']['zrap'].append(1001)
#conf['steps'][1]['datasets']['wasym']=[]
#conf['steps'][1]['datasets']['wasym'].append(1000)
#conf['steps'][1]['datasets']['wasym'].append(1001)
#conf['steps'][1]['datasets']['wzrv']=[]
#conf['steps'][1]['datasets']['wzrv'].append(2000)
#conf['steps'][1]['datasets']['wzrv'].append(2003)
#conf['steps'][1]['datasets']['wzrv'].append(2006)
#conf['steps'][1]['datasets']['wzrv'].append(2007)
#conf['steps'][1]['datasets']['wzrv'].append(2009)
#conf['steps'][1]['datasets']['wzrv'].append(2010)
#conf['steps'][1]['datasets']['wzrv'].append(2011)
#conf['steps'][1]['datasets']['wzrv'].append(2012)
#conf['steps'][1]['datasets']['wzrv'].append(2013)
#conf['steps'][1]['datasets']['wzrv'].append(2014)
#conf['steps'][1]['datasets']['wzrv'].append(2015)
#conf['steps'][1]['datasets']['jet'] = []
#conf['steps'][1]['datasets']['jet'].append(10001) ## D0 dataset
#conf['steps'][1]['datasets']['jet'].append(10002) ## CDF dataset
#conf['steps'][1]['datasets']['jet'].append(10003) ## STAR MB dataset
#conf['steps'][1]['datasets']['jet'].append(10004) ## STAR HT dataset

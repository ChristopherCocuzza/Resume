...
#conf['steps'][14]['datasets']['idis'].append(10041) # h/d      | F2h/F2d       | JLab Hall C (E03-103)
#conf['steps'][14]['datasets']['idis'].append(10050) # d/p      | F2d/F2p       | MARATHON
#conf['steps'][14]['datasets']['idis'].append(10051) # h/t      | F2h/F2t       | MARATHON
conf['steps'][14]['datasets']['dy']=[]
conf['steps'][14]['datasets']['dy'].append(10001)
conf['steps'][14]['datasets']['dy'].append(20001)
...
conf['steps'][14]['datasets']['wzrv'].append(2016)
conf['steps'][14]['datasets']['wzrv'].append(2017)
conf['steps'][14]['datasets']['wzrv'].append(2020)
conf['steps'][14]['datasets']['jet'] = []
conf['steps'][14]['datasets']['jet'].append(10001) ## D0 dataset
conf['steps'][14]['datasets']['jet'].append(10002) ## CDF dataset
conf['steps'][14]['datasets']['jet'].append(10003) ## STAR MB dataset
conf['steps'][14]['datasets']['jet'].append(10004) ## STAR HT dataset

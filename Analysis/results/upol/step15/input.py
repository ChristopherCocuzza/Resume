...
conf['steps'][15]['active distributions']=['pdf','ht4']
...
#conf['steps'][15]['datasets']['idis'].append(10041) # h/d      | F2h/F2d       | JLab Hall C (E03-103)
#conf['steps'][15]['datasets']['idis'].append(10050) # d/p      | F2d/F2p       | MARATHON
#conf['steps'][15]['datasets']['idis'].append(10051) # h/t      | F2h/F2t       | MARATHON
conf['steps'][15]['datasets']['dy']=[]
conf['steps'][15]['datasets']['dy'].append(10001)
conf['steps'][15]['datasets']['dy'].append(20001)
conf['steps'][15]['datasets']['dy'].append(20002)
...
conf['steps'][15]['datasets']['wzrv'].append(2016)
conf['steps'][15]['datasets']['wzrv'].append(2017)
conf['steps'][15]['datasets']['wzrv'].append(2020)
conf['steps'][15]['datasets']['jet'] = []
conf['steps'][15]['datasets']['jet'].append(10001) ## D0 dataset
conf['steps'][15]['datasets']['jet'].append(10002) ## CDF dataset
conf['steps'][15]['datasets']['jet'].append(10003) ## STAR MB dataset
conf['steps'][15]['datasets']['jet'].append(10004) ## STAR HT dataset

conf['FILT'] = {_:[] for _ in ['exp','par','value']}

conf['FILT']['exp'].append(('dy',20001,8))
conf['FILT']['exp'].append(('dy',20002,10))


conf['FILT']['value'].append(('pdf','db/ub','>',1.7,0.25,10))

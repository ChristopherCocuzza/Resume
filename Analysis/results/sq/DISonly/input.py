...
#------------------------------------------------------------------------------------------------------------------
conf['datasets']['dy']['xlsx'][10001]='dy/expdata/10001cut.xlsx'
...
#conf['steps'][12]['datasets']['idis'].append(10041) # h/d      | F2h/F2d       | JLab Hall C (E03-103)
#conf['steps'][12]['datasets']['idis'].append(10050) # d/p      | F2d/F2p       | MARATHON
#conf['steps'][12]['datasets']['idis'].append(10051) # h/t      | F2h/F2t       | MARATHON
#conf['steps'][12]['datasets']['dy']=[]
#conf['steps'][12]['datasets']['dy'].append(10001)
#conf['steps'][12]['datasets']['dy'].append(20001)
#conf['steps'][12]['datasets']['zrap']=[]
#conf['steps'][12]['datasets']['zrap'].append(1000)
#conf['steps'][12]['datasets']['zrap'].append(1001)
#conf['steps'][12]['datasets']['wzrv']=[]
#conf['steps'][12]['datasets']['wzrv'].append(2000)
#conf['steps'][12]['datasets']['wzrv'].append(2003)
#conf['steps'][12]['datasets']['wzrv'].append(2006)
#conf['steps'][12]['datasets']['wzrv'].append(2007)
#conf['steps'][12]['datasets']['wzrv'].append(2008)
#conf['steps'][12]['datasets']['wzrv'].append(2009)
#conf['steps'][12]['datasets']['wzrv'].append(2010)
#conf['steps'][12]['datasets']['wzrv'].append(2011)
#conf['steps'][12]['datasets']['wzrv'].append(2012)
#conf['steps'][12]['datasets']['wzrv'].append(2013)
#conf['steps'][12]['datasets']['wzrv'].append(2014)
#conf['steps'][12]['datasets']['jet'] = []
#conf['steps'][12]['datasets']['jet'].append(10001) ## D0 dataset
#conf['steps'][12]['datasets']['jet'].append(10002) ## CDF dataset
#conf['steps'][12]['datasets']['jet'].append(10003) ## STAR MB dataset
#conf['steps'][12]['datasets']['jet'].append(10004) ## STAR HT dataset

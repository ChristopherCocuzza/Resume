...
istep=29
#--free ffkaon s (PDIS W2 > 10, Q2 > mc2, no Ape (w/ smearing, valence parameterization, OS+ for all, g2 = 0))
conf['ftol']=1e-6
conf['tmc']     = 'AOT'
conf['ht']      = True
conf['ht type'] = 'mult'
...
conf['ww']  = False
conf['steps'][istep]={}
conf['steps'][istep]['dep']=[19,28]
conf['steps'][istep]['active distributions']=['ppdf','ffpion','ffkaon']
conf['steps'][istep]['passive distributions']=['pdf','ht4','off pdf']
conf['params']['ffkaon']['s1 N']['prior'] = 'd1 N'
conf['params']['ffkaon']['s1 a']['prior'] = 'd1 a'
conf['params']['ffkaon']['s1 b']['prior'] = 'd1 b'
#------------------------------------------------------------------------------------------------------------------

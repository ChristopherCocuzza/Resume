...
conf['params']['ffpion']['s1 a']  ={'value':    3.00305e-01, 'min': -1.8 , 'max':    10,'fixed':'d1 a'}
conf['params']['ffpion']['s1 b']  ={'value':    1.83178e+00, 'min':  0   , 'max':    30,'fixed':'d1 b'}
...
conf['params']['ffpion']['sb1 a'] ={'value':    3.00305e-01, 'min': -1.8 , 'max':    10,'fixed':'d1 a'}
conf['params']['ffpion']['sb1 b'] ={'value':    1.83178e+00, 'min':  0   , 'max':    30,'fixed':'d1 b'}
...
conf['params']['ffkaon']['d1 b']  ={'value':   1.65143e+00, 'min':  0   , 'max':    30,'fixed':False}
...
conf['params']['ffkaon']['s1 b']  ={'value':   1.65143e+00, 'min':  0   , 'max':    30,'fixed':'d1 b'}
...
istep=23
#--fit pion SIA (PDIS W2 > 10, Q2 > mc2, no Ape (w/ smearing, valence parameterization, OS for all, SU2+SU3 from JAM17, g2 = 0))
conf['ftol']=1e-6
conf['tmc']     = 'AOT'
conf['ht']      = True
conf['ht type'] = 'mult'
...
conf['steps'][istep]['active distributions']=['ffpion']
...
conf['FILT']['exp'].append(('sia',1001,10))
conf['FILT']['exp'].append(('sia',1002,10))
conf['FILT']['exp'].append(('sia',1003,10))
conf['FILT']['exp'].append(('sia',1004,10))
conf['FILT']['exp'].append(('sia',1005,10))
conf['FILT']['exp'].append(('sia',1006,10))
conf['FILT']['exp'].append(('sia',1007,10))
conf['FILT']['exp'].append(('sia',1008,10))
conf['FILT']['exp'].append(('sia',1012,10))
conf['FILT']['exp'].append(('sia',1013,10))
conf['FILT']['exp'].append(('sia',1014,10))
conf['FILT']['exp'].append(('sia',1018,10))
conf['FILT']['exp'].append(('sia',1019,10))
conf['FILT']['exp'].append(('sia',1025,10))
conf['FILT']['exp'].append(('sia',1028,10))
conf['FILT']['exp'].append(('sia',1029,10))
conf['FILT']['exp'].append(('sia',1030,10))
conf['FILT']['exp'].append(('sia',1010,10))
conf['FILT']['exp'].append(('sia',1011,10))
conf['FILT']['exp'].append(('sia',1016,10))
conf['FILT']['exp'].append(('sia',1017,10))
conf['FILT']['exp'].append(('sia',1023,10))
conf['FILT']['exp'].append(('sia',1024,10))
conf['FILT']['exp'].append(('sia',1027,10))

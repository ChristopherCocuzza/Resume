...
istep=21
#--OS+ for all PPDFs (PDIS W2 > 10, Q2 > mc2, no Ape (w/ smearing, valence parameterization, OS for all, SU2+SU3 from JAM17, g2 = 0))
conf['ftol']=1e-6
conf['tmc']     = 'AOT'
conf['ht']      = True
conf['ht type'] = 'mult'
...
conf['params']['ppdf']['g1 d']  ['zero'] = True 
conf['params']['ppdf']['uv1 d'] ['zero'] = True 
conf['params']['ppdf']['dv1 d'] ['zero'] = True 
conf['params']['ppdf']['s1 d']  ['zero'] = True 
conf['params']['ppdf']['sea1 d']['zero'] = True 
#------------------------------------------------------------------------------------------------------------------

...
istep=22
#--free ub, db, and sb (PDIS W2 > 10, Q2 > mc2, no Ape (w/ smearing, valence parameterization, OS for all, SU2+SU3 from JAM17, g2 = 0))
conf['ftol']=1e-6
conf['tmc']     = 'AOT'
conf['ht']      = True
conf['ht type'] = 'mult'
...
conf['params']['ppdf']['ub1 N']['prior'] = 's1 N' 
conf['params']['ppdf']['ub1 a']['prior'] = 's1 a' 
conf['params']['ppdf']['ub1 b']['prior'] = 's1 b' 
conf['params']['ppdf']['ub1 d']['prior'] = 's1 d' 
conf['params']['ppdf']['db1 N']['prior'] = 's1 N' 
conf['params']['ppdf']['db1 a']['prior'] = 's1 a' 
conf['params']['ppdf']['db1 b']['prior'] = 's1 b' 
conf['params']['ppdf']['db1 d']['prior'] = 's1 d' 
conf['params']['ppdf']['sb1 N']['prior'] = 's1 N' 
conf['params']['ppdf']['sb1 a']['prior'] = 's1 a' 
conf['params']['ppdf']['sb1 b']['prior'] = 's1 b' 
conf['params']['ppdf']['sb1 d']['prior'] = 's1 d' 
#------------------------------------------------------------------------------------------------------------------
...
conf['FILT']['exp'].append(('SU23' ,20001,10))
conf['FILT']['exp'].append(('SU23' ,20002,10))

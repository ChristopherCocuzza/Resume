...
def load_data(W2cut=3):
    ...
    #------------------------------------------------------------------------------------------------------------------
    conf['datasets']['dy']['xlsx'][10011]='dy/expdata/10011.xlsx'
    conf['datasets']['dy']['xlsx'][10012]='dy/expdata/10012.xlsx'
...
if __name__ == "__main__":
    ...
    for exp in data:
        ...
        for idx in data[exp]:
            ...
            if exp == 'dy':
                if   idx == 10011: marker,color,label  = 'D','purple','FNAL E866'
                elif idx == 10012: marker,color        = 'D','purple'
                elif idx == 20002: marker,color,label  = 'o','cyan', 'FNAL E906'
                else: continue
            if exp == 'wasym':
            ...
            if exp == 'wzrv':
                ...
                elif idx == 2003: marker,color       = 'p','maroon'
                elif idx == 2006: marker,color       = 'p','maroon'
                elif idx == 2007: marker,color,label = '*','darkcyan','ATLAS/CMS W'
                elif idx == 2009: marker,color       = '*','darkcyan'
                elif idx == 2010: marker,color       = '*','darkcyan'
                ...
                elif idx == 2015: marker,color       = '*','darkcyan'
                elif idx == 2020: marker,color,label = 'o','red','STAR W'
                else: continue
            if exp == 'jet':
            ...
            if exp=='idis' and idx in [10050,10051]: s,zorder = 50,  3
    ...
    handles.append(hand['blank'])
    handles.append(hand['blank'])
    labels.append(r'\textbf{\textrm{FNAL E906}}')
